...
public:
	// Get COM port list
	static void GetComList(VEC_STR& vec);
	...
	void SetDefaultParameters(EBaudrate eBaudrate = EBaud9600,
		EDataBits eDataBits = EData8,
		EParity   eParity   = EParNone,
		EStopBits eStopBits = EStop1
		)
	{
		m_defBaudrate=eBaudrate;
		m_defDataBits=eDataBits;
		m_defParity=eParity;
		m_defStopBits=eStopBits;
	}
...
protected:
	...
	EBaudrate m_defBaudrate;
	EDataBits m_defDataBits;
	EParity	  m_defParity;
	EStopBits m_defStopBits;
